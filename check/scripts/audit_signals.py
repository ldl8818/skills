#!/usr/bin/env python3
"""Project audit signals for /check audit mode.

Walks a project root and emits structured signal blocks to stdout.
Each block ends with `status: PASS|WARN|FAIL|N/A`. Signals locate review
candidates; they are not a quality score or a final finding.
...
# Keep file traversal self-contained so this helper works after direct installation.
